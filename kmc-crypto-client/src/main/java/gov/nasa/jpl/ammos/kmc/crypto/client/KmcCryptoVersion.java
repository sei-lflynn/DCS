 ...
 * <code>java -jar kmc-crypto-client.jar</code>.
 *
 *
 */
public final class KmcCryptoVersion {
    ...
    public static void main(final String[] args) {
        ...
        System.out.println("KMC Cryptography Service Client");
        try {
            URL res = gov.nasa.jpl.ammos.kmc.crypto.client.KmcCryptoVersion.class.getResource(KmcCryptoVersion.class.getSimpleName() + ".class");
